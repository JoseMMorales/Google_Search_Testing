...
This project is an example of UI automated functional test for Google home page and search, using WebDriver, Selenium and Java. Running the scripts in two different environments like Google Chrome Driver and Firefox driver.
